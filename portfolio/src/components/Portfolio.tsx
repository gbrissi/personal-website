            ...
            <Fade timeout={1000} in>
              <GridContainer sx={{color: props.gridFontColor}}container>
                ...
                <ImageContainer item xs={12} sm={6} md={4} lg={3}>
                  ...
                  <ImageTypography sx={{color: props.imageContainerFontColor}} variant='body2'>First web application that I had done. Built along Rocketseat Discover course.</ImageTypography>
                  <ImageWrapper sx={{backgroundColor: props.gridColor}}>
